...
CREATE VIEW elo_f1_view_top_peak_rankings AS
    ...
    FROM elo_f1_rankings
        JOIN elo_f1_view_top_yearly_rankings ON YEAR(elo_f1_rankings.rank_date) = elo_f1_view_top_yearly_rankings.date AND elo_f1_rankings.ranking = elo_f1_view_top_yearly_rankings.peak
